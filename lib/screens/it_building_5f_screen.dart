...
class ItBuilding5fScreen extends StatelessWidget {
  ...
  final List<IconInfo> icons = [
    IconInfo(asset: 'assets/icons/stairs.svg', left: 80, top: 319),
    IconInfo(asset: 'assets/icons/stairs.svg', left: 852, top: 290),
    IconInfo(asset: 'assets/icons/stairs.svg', left: 1665, top: 384),
    IconInfo(asset: 'assets/icons/elevator.svg', left: 998, top: 283),
  ];
